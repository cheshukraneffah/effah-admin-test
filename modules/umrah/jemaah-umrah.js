...
async function addNewOptionToField(fieldName, newOptionName){
  try{
    ...
    // V65 FIX - ikut doc official Airtable dari PDF: existing MESTI ada id, baru TANPA id
    // Jangan spread ...fieldMeta.options, hantar hanya choices
    ...
    if(!res.ok){
      ...
      console.error('Meta API error:', txt);
      alert('Gagal melaksanakan operasi: '+txt); return false;
    }
